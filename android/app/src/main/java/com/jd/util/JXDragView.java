 ...
 */
public class JXDragView implements View.OnTouchListener {
    ...
    private JXDragView(JXDragView.Builder builder) {
        mBuilder = builder;
        initDragView();
    }
    ...
    private static JXDragView createDragView(JXDragView.Builder builder) {
        if (null == builder) {
        ...
        JXDragView JXDragView = new JXDragView(builder);
        return JXDragView;
    }
    ...
    public static class Builder {
        ...
        public Builder setOnConfigurationChangedListener(OnConfigurationChangedListener listener) {
            this.configurationChangedListener = listener;
            return this;
        }

        public JXDragView build() {
