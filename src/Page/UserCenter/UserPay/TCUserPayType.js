...
//         let page = code === "WX_PUBLIC" ?  JX_Compones.WxPublicPage : JX_Compones.UserPayment
//
//         TW_Log("======gotoPayPage=======page---"+page, code);
//         TW_NavHelp.pushView(page,{
//             code: code,
//             payList: payList,
